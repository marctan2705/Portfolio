...
function Page1(props) {
    ...
    <div className={classes.list}>
        <p className={classes.newhits}>Popular songs</p>
        <div className={classes.row}>
            <div className={classes.song} onMouseOver={() => {setIsHovering(1)}} onMouseLeave={() => {setIsHovering(0)}} onClick={props.handleClick}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 1 ? <img src={play} className={classes.play}/> : null}
            </div>
            <div className={classes.song} onMouseOver={() => {setIsHovering(2)}} onMouseLeave={() => {setIsHovering(0)}}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 2 ? <img src={play} className={classes.play}/> : null}
            </div>
        </div>
        <div className={classes.row}>
           <div className={classes.song} onMouseOver={() => {setIsHovering(6)}} onMouseLeave={() => {setIsHovering(0)}}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 6 ? <img src={play} className={classes.play}/> : null}
            </div>
           <div className={classes.song} onMouseOver={() => {setIsHovering(3)}} onMouseLeave={() => {setIsHovering(0)}}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 3 ? <img src={play} className={classes.play}/> : null}
            </div>
        </div>
        <div className={classes.row}>
           <div className={classes.song} onMouseOver={() => {setIsHovering(4)}} onMouseLeave={() => {setIsHovering(0)}}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 4 ? <img src={play} className={classes.play}/> : null}
            </div>
           <div className={classes.song} onMouseOver={() => {setIsHovering(5)}} onMouseLeave={() => {setIsHovering(0)}}>
                <div className={classes.artname}>
                <img className={classes.art} src={car} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

                {isHovering == 5 ? <img src={play} className={classes.play}/> : null}
            </div>
        </div>
        <p className={classes.newhits}>Industry Albums</p>
